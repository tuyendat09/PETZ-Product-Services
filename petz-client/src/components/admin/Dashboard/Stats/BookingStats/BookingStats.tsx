...
export default function BookingStats() {
  ...
  return (
    <div className="relative z-20 mt-8 w-full rounded-lg bg-white p-8 shadow-lg dark:bg-[#18181b] dark:text-white">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Doanh thu lịch đặt</h1>
        <p className="text-gray-500">
          Xem tổng quan doanh thu và trạng thái lịch đặt
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <div className="rounded-lg bg-green-50 p-4 shadow-md">
          ...
          <p className="mt-2 text-2xl font-semibold text-green-900">
            {data.bookingsDone} đơn
          </p>
        </div>

        <div className="rounded-lg bg-red-50 p-4 shadow-md">
          <h2 className="text-lg font-medium text-red-700">Lịch đặt đã hủy</h2>
          <p className="mt-2 text-2xl font-semibold text-red-900">
            {data.bookingsCancelled} đơn
          </p>
        </div>
      </div>
      ...
      {/* <div className="mt-8">
        <button
          ...
          className="w-full rounded-lg bg-indigo-600 p-3 text-white font-medium shadow-md hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-500"
        >
